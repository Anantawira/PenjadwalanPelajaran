...
public class JFrameAdminHariJumat extends javax.swing.JFrame {
    ...
    private void Btn_PrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_PrintActionPerformed
        try {
            jTableAdminHariJumat.print(JTable.PrintMode.FIT_WIDTH, new MessageFormat("JADWAL PELAJARAN HARI JUMAT"), null);
        } catch (PrinterException ex) {
            Logger.getLogger(JFrameAdminHariJumat.class.getName()).log(Level.SEVERE, null, ex);
        }
