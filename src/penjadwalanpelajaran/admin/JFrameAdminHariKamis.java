...
public class JFrameAdminHariKamis extends javax.swing.JFrame {
    ...
    public JFrameAdminHariKamis() {
        ...
        jTableAdminHariKamis.getTableHeader().setFont(new Font("SEGOE UI", Font.BOLD, 12));
        jTableAdminHariKamis.getTableHeader().setOpaque(false);
        jTableAdminHariKamis.getTableHeader().setForeground(Color.BLACK);
        jTableAdminHariKamis.setRowHeight(25);
    }
    
    public void ComboBoxCariKelas() {
        try {
            String sql = "SELECT DISTINCT kelas FROM tb_jadwal_mapel WHERE " + " hari LIKE '%" + "Kamis" + "%' ORDER BY kelas ASC ";
    ...
    private void LoadTable() {
        ...
        try {
            ...
            jTableAdminHariKamis.setModel(model);
        } catch (Exception e) {
        }
    }
    ...
    private void initComponents() {
        ...
        jTableAdminHariKamis = new javax.swing.JTable();
        ...
        jTableAdminHariKamis.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
    ...
    private void Btn_Cari_KelasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_Cari_KelasActionPerformed
        try {
            Statement stat = (Statement) Config.configDB().createStatement();
            ResultSet res = stat.executeQuery("SELECT * FROM tb_jadwal_mapel WHERE " + " kelas LIKE '%" + Cmbx_Cari_Kelas.getSelectedItem()+ "%' AND " + " hari LIKE '%" + "Kamis" + "%' ORDER BY nama_guru ASC ");
            DefaultTableModel model = new DefaultTableModel();
            model.addColumn("ID");
            model.addColumn("Guru Pengajar");
            model.addColumn("Sesi");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameAdminHariKamis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable jTableAdminHariKamis;
