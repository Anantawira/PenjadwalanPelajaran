...
public class JFrameHariKamis extends javax.swing.JFrame {

    public JFrameHariKamis() {
        initComponents();
        setExtendedState(JFrameHariKamis.MAXIMIZED_BOTH);
        LoadTable();
        
        jTableHariKamis.getTableHeader().setFont(new Font("SEGOE UI", Font.BOLD, 12));
        jTableHariKamis.getTableHeader().setOpaque(false);
        jTableHariKamis.getTableHeader().setForeground(Color.BLACK);
        jTableHariKamis.setRowHeight(25);
    }
    ...
    private void LoadTable() {
        ...
        try {
            //int no = 1;
            String sql = "SELECT * FROM tb_jadwal_mapel WHERE " + " hari LIKE '%" + "Kamis" + "%' ORDER BY nama_guru ASC ";
            ...
            jTableHariKamis.setModel(model);
        } catch (Exception e) {
        }
    }
    ...
    private void initComponents() {
        ...
        jTableHariKamis = new javax.swing.JTable();
        ...
        jLabel1.setText("Jadwal Pelajaran Hari Kamis");
        ...
        jTableHariKamis.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jTableHariKamis.setShowVerticalLines(false);
        jScrollPane1.setViewportView(jTableHariKamis);
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(Btn_Refresh_Cari, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void Btn_Cari_GuruActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_Cari_GuruActionPerformed
        try {
            ...
            ResultSet res = stat.executeQuery("SELECT * FROM tb_jadwal_mapel WHERE " + " nama_guru LIKE '%" + Txt_Cari_Guru.getText() + "%' AND " + " hari LIKE '%" + "Kamis" + "%' ");
            DefaultTableModel model = new DefaultTableModel();
            model.addColumn("Guru Pengajar");
            model.addColumn("Sesi");
            model.addColumn("Mata Pelajaran");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameHariKamis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameHariKamis().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTableHariKamis;
