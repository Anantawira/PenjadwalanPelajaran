...
public class JFrameHariJumat extends javax.swing.JFrame {

    public JFrameHariJumat() {
        initComponents();
        setExtendedState(JFrameHariJumat.MAXIMIZED_BOTH);
        LoadTable();

        jTableHariJumat.getTableHeader().setFont(new Font("SEGOE UI", Font.BOLD, 12));
        jTableHariJumat.getTableHeader().setOpaque(false);
        jTableHariJumat.getTableHeader().setForeground(Color.BLACK);
        jTableHariJumat.setRowHeight(25);
    }
    ...
    private void LoadTable() {
        ...
        try {
            ...
            jTableHariJumat.setModel(model);
        } catch (Exception e) {
        }
    }
    ...
    private void initComponents() {
        ...
        jTableHariJumat = new javax.swing.JTable();
        ...
        jTableHariJumat.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jTableHariJumat.setShowVerticalLines(false);
        jScrollPane1.setViewportView(jTableHariJumat);
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(Btn_Refresh_Cari, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void Btn_Cari_GuruActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_Cari_GuruActionPerformed
        try {
            ...
            ResultSet res = stat.executeQuery("SELECT * FROM tb_jadwal_mapel WHERE " + " nama_guru LIKE '%" + Txt_Cari_Guru.getText() + "%' AND " + " hari LIKE '%" + "Jumat" + "%' ");
            DefaultTableModel model = new DefaultTableModel();
            model.addColumn("Guru Pengajar");
            model.addColumn("Sesi");
            model.addColumn("Mata Pelajaran");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameHariJumat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameHariJumat().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTableHariJumat;
