...
public class JFrameHariRabu extends javax.swing.JFrame {
    ...
    public JFrameHariRabu() {
        ...
        jTableHariRabu.getTableHeader().setFont(new Font("SEGOE UI", Font.BOLD, 12));
    ...
    private void initComponents() {
        ...
        jTableHariRabu.setShowVerticalLines(false);
    ...
    private void Btn_Cari_GuruActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_Cari_GuruActionPerformed
        try {
            ...
            ResultSet res = stat.executeQuery("SELECT * FROM tb_jadwal_mapel WHERE " + " nama_guru LIKE '%" + Txt_Cari_Guru.getText() + "%' AND " + " hari LIKE '%" + "Rabu" + "%' ");
            DefaultTableModel model = new DefaultTableModel();
            model.addColumn("Guru Pengajar");
            model.addColumn("Sesi");
            model.addColumn("Mata Pelajaran");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameHariRabu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameHariRabu().setVisible(true);
            }
        });
    }
